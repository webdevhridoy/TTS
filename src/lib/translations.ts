    ...
    pricing: {
      ...
      pro: {
        ...
        features: [
          ...
          "Top-priority voice generation for faster output",
          "Access to premium & exclusive voices",
  ...
  ar: {
    ...
    voices: {
      ...
      nour: {
        name: "نور (Nour)",
        style: "مشرق وشبابي",
        desc: "نابض بالحيوية والطاقة — مثالي للمحتوى الموجه للشباب وماركات أسلوب الحياة والمقاطع الاجتماعية.",
      },
      sara: {
        name: "سارة (Sara)",
        style: "هادئ وتعليمي",
    ...
    pricing: {
      ...
      subtitle: "ابدأ مجاناً، وقم بالترقية عندما تحتاج إلى التوسع.",
      free: {
        name: "الخطة المجانية",
        price: "0$",
        period: "/شهر",
      ...
      pro: {
        ...
        features: [
          "50,000 حرف شهرياً",
          "أولوية قصوى لتوليد الصوت للحصول عليه أسرع",
          "الوصول للأصوات المتميزة والحصرية",
          "حقوق الاستخدام التجاري متضمنة",
        ],
        cta: "ابدأ في الإنتاج",
      },
    },
